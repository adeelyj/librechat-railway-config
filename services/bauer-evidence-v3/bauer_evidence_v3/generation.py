...
class OpenAICompatibleModelGateway:
    ...
    async def generate(self, request: GenerationRequest) -> str:
        system = (
            ...
            "Do not broaden an integration or installation statement into compatibility. When "
            "evidence says a product can be integrated directly on top of named units, repeat that "
            "relationship exactly; do not paraphrase it as installed or call it compatible. "
        ...
        if request.previous_answer is not None:
            ...
            repair = (
                ...
                "cross-row merge, navigation claim, filename, path, or source list. Do not broaden "
                "integration or installation into compatibility. If the evidence says integrated "
                "directly on top, repeat those exact relationship words rather than installed. Use adjacent "
