...
class OpenAICompatibleModelGateway:
    ...
    async def generate(self, request: GenerationRequest) -> str:
        system = (
            ...
            "Do not broaden an installation statement into compatibility: when evidence says a "
            "product can be installed directly on top of named units, state only that installation "
            "relationship and do not call it compatible or an integration. "
        ...
        if request.previous_answer is not None:
            ...
            repair = (
                ...
                "an installation statement into compatibility or integration; use the exact "
                "installation relationship from the evidence. Use adjacent "
