...
def render(
    ...
    *,
    ...
    lines = [
        ...
        "assistant text returned by V1, V2, V3, and V4. The locked holdout was not opened.",
        "",
        (
        ...
        *_metric_table(score),
        "",
        "The exact-answer gold is interim-reviewed and not independently Bauer-verified. V4 was scored",
        "with the same existing validator, extended only to recognize V4's stable citation identities.",
        "",
